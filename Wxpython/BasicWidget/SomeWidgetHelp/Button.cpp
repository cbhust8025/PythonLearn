Help on class Button in module wx._controls:
...
class Button(AnyButton)
 ...
 |  
 |  GetAuthNeeded(*args, **kwargs)
 |      GetAuthNeeded(self) -> bool
 |  
 |  SetAuthNeeded(*args, **kwargs)
 ...
 |  
 |  ----------------------------------------------------------------------
 |  Methods inherited from AnyButton:
 |  
 ...
 |  
 |  SetBitmap(*args, **kwargs)
 |      SetBitmap(self, Bitmap bitmap, int dir=LEFT)
 |  
 |  SetBitmapCurrent(*args, **kwargs)
 ...
 |  
 |  ----------------------------------------------------------------------
 |  Data descriptors inherited from AnyButton:
 |  
 |  Bitmap
 |      GetBitmap(self) -> Bitmap
 |  
